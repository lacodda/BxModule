<?php
     ...
     * класса \Lacodda\BxModule\EntityManager.
     *
     * @see    EntityManager
    ...
    abstract class HelperWidget
    {
        ...
        {
            if (is_a ($this->helper, 'Lacodda\BxModule\Helper\AdminListHelper'))
            {
                return self::LIST_HELPER;
            } else
            {
                if (is_a ($this->helper, 'Lacodda\BxModule\Helper\AdminEditHelper'))
                {
