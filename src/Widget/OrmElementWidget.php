<?php
    ...
    use Lacodda\BxModule\Helper\AdminBaseHelper;
     ...
     * наследником `\Lacodda\BxModule\Helper\AdminBaseHelper`.
        ...
        extends NumberWidget
    {
        ...
        public function loadSettings ($code = null)
        {
            ...
            if (!is_subclass_of ($this->getSettings ('HELPER'), '\Lacodda\BxModule\Helper\AdminBaseHelper'))
            {
                throw new ArgumentTypeException('HELPER', '\Lacodda\BxModule\Helper\AdminBaseHelper');
            }
        ...
        {
            /**
             * @var \Lacodda\BxModule\Helper\AdminBaseHelper $linkedHelper
             */
            $linkedHelper = $this->getSettings ('HELPER');
