<?php
    ...
    use Lacodda\BxModule\EntityManager;
    use Lacodda\BxModule\Widget\HelperWidget;
    ...
    abstract class AdminBaseHelper
    {
         ...
         */
        static protected $routerUrl = '/bitrix/admin/bxmodule_route.php';
         ...
         * @api
         */
        static protected $entityManager = '\Lacodda\BxModule\EntityManager';
         ...
         *
         * @return bool|\Lacodda\BxModule\Widget\HelperWidget
         *
         * @throws \Lacodda\BxModule\Helper\Exception
         *
         * @internal
         */
         ...
         *
         * @param \Lacodda\BxModule\Widget\HelperWidget $widget
         * @param array                                 $data
         */
