<?php
    ...
    if (is_subclass_of ($helper, 'Lacodda\BxModule\Helper\AdminEditHelper'))
    {
        $helperType = 'edit';
        /**
    ...
    } elseif (is_subclass_of ($helper, 'Lacodda\BxModule\Helper\AdminListHelper'))
    {
        $helperType = 'list';
        /**
    ...
    } elseif (is_subclass_of ($helper, 'Lacodda\BxModule\Helper\AdminBaseHelper'))
    {
        $adminHelper = new $helper($fields, $tabs);
    } else
    {
